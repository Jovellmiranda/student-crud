...
@Controller
@RequestMapping(path="/miranda/student") // Updated URI
public class MainController {
    ...
    public ResponseEntity createStudent(@RequestBody Student student) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/miranda/student/" + savedStudent.getId())).body(savedStudent);
    }
